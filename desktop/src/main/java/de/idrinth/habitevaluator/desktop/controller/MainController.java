...
import de.idrinth.habitevaluator.desktop.persistence.H2PlannerGroupRepository;
import de.idrinth.habitevaluator.desktop.persistence.H2PlannerActivityRepository;
import de.idrinth.habitevaluator.desktop.persistence.H2WeekPlannerSlotRepository;
import de.idrinth.habitevaluator.desktop.persistence.H2SlotConfirmationRepository;
...
public class MainController {
    ...
    private PlannerActivityRepository plannerActivityRepository;
    private WeekPlannerSlotRepository weekPlannerSlotRepository;
    private SlotConfirmationRepository slotConfirmationRepository;
    ...
    private void initializeLocalStorage() {
        ...
        plannerGroupRepository = new H2PlannerGroupRepository();
        plannerActivityRepository = new H2PlannerActivityRepository();
        weekPlannerSlotRepository = new H2WeekPlannerSlotRepository();
        slotConfirmationRepository = new H2SlotConfirmationRepository();
        apiClient = null;
