...
public class DiaryNavigationFragment extends Fragment {
    ...
    static final String[] NAVIGATION_TARGETS = {
            "positivityDiary", "sportLog", "foodLog", "medicationLog", "medicationList", "activityLog"
    };
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.activityLogCard.setOnClickListener(v -> {
            if (getActivity() instanceof MainActivity) {
                ((MainActivity) getActivity()).navigateToActivityLog();
            }
        });
    }
